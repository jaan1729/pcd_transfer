...
int main(int argc, char** argv) { 
  ...
  std::cout << "CURRENT pcloud size: " << pcloud_data.size() * sizeof(pcloud_data[0]) << std::endl;
...
int main(int argc, char** argv) {
    std::string file_path = "/home/surya/workspace/digiflec/ros_ws/src/pcd_compresser/src/stpcc/src";
    std::string file_name = "pcc_file_encoder.cpp";
    float pitch_precision = 0.1f;
    float yaw_precision = 0.1f;
